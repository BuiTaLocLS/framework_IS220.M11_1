                        ...
                        <div className="col-md-8">
                            ...
                            <div className="card mb-4 mb-lg-0">
                                <div className="card-body">
                                    ...
                                    <img className="me-2" src="https://mdbcdn.b-cdn.net/wp-content/plugins/woocommerce-gateway-stripe/assets/images/visa.svg" alt="Visa" width="45px" />
                                    <img className="me-2" src="https://mdbcdn.b-cdn.net/wp-content/plugins/woocommerce-gateway-stripe/assets/images/amex.svg" alt="American Express" width="45px" />
                                    <img className="me-2" src="https://mdbcdn.b-cdn.net/wp-content/plugins/woocommerce-gateway-stripe/assets/images/mastercard.svg" alt="Mastercard" width="45px" />
                                    <img className="me-2" src="https://mdbcdn.b-cdn.net/wp-content/plugins/woocommerce/includes/gateways/paypal/assets/images/paypal.webp" alt="PayPal acceptance mark" width="45px" />
                                </div>
                            </div>
                        </div>
