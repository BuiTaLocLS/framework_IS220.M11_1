          ...
          <div className="grid-body">
            <div className="row">
              ...
              <div className="col-md-3">
                <h2 className="grid-title"><i className="fa fa-filter" /> Filters</h2>
                <hr />
                ...
                <div className="slider-primary">
                  <div className="slider slider-horizontal" style={{width: '152px'}}><div className="slider-track"><div className="slider-selection" style={{left: '30%', width: '50%'}} /><div className="slider-handle round" style={{left: '30%'}} /><div className="slider-handle round" style={{left: '80%'}} /></div><div className="tooltip top hide" style={{top: '-30px', left: '50.1px'}}><div className="tooltip-arrow" /><div className="tooltip-inner">300 : 800</div></div><input type="text" className="slider" defaultValue data-slider-min={0} data-slider-max={1000} data-slider-step={1} data-slider-value="[300,800]" data-slider-tooltip="hide" /></div>
                </div>
                {/* END FILTER BY PRICE */}
              </div>
              {/* END FILTERS */}
              ...
              <div className="col-md-9">
                <h2><i className="fa fa-file-o" /> Result</h2>
                <hr />
                {/* BEGIN SEARCH INPUT */}
                ...
                <div className="table-responsive">
                  <table className="table table-hover">
                    <tbody><tr>
                        ...
                        <td className="rate text-right"><span><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star-half-o" /></span></td>
                      ...
                      <tr>
                        ...
                        <td className="rate text-right"><span><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star-o" /><i className="fa fa-star-o" /></span></td>
                      ...
                      <tr>
                        ...
                        <td className="rate text-right"><span><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star-half-o" /><i className="fa fa-star-o" /></span></td>
                      ...
                      <tr>
                        ...
                        <td className="rate text-right"><span><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star-o" /></span></td>
                      ...
                      <tr>
                        ...
                        <td className="rate text-right"><span><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star" /></span></td>
                      ...
                      <tr>
                        ...
                        <td className="rate text-right"><span><i className="fa fa-star" /><i className="fa fa-star" /><i className="fa fa-star-o" /><i className="fa fa-star-o" /><i className="fa fa-star-o" /></span></td>
